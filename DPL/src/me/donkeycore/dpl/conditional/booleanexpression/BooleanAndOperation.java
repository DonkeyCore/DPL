...
/**
 * To evaluate AND operations between 2 {@link IBoolean}.
 * 
...
final class BooleanAndOperation implements IBoolean {
	...
	/**
	 * Evaluate the AND operation between the first {@link IBoolean} and the
	 * second {@link IBoolean} supplied in the constructor.
	 * 
	 * @return <code>true</code> or <code>false</code> dependenig the result
	 *         of the AND operation between the first {@link IBoolean} and the
	 *         second {@link IBoolean} supplied in the constructor.
	 * 
	...
	/**
	 * A String representation of the AND operation between the first {@link IBoolean} and the second {@link IBoolean} supplied in the
	 * constructor.
	 * 
