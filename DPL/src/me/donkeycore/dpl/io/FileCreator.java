...
public class FileCreator{
	...
	private static java.util.ArrayList<File> files = new java.util.ArrayList<File>();
	...
	/** Create a file based on its name. This method is automatically called by all the methods to retrieve files when creating a file. <br/> <br />
	 * <b>
