...
public class Expression{
	...
	/** Evaluate a math expression using the {@link ScriptEngine JavaScript} engine.
	 * <h1>Syntax:</h1>
	 * <pre>
	...
	/** Evaluate a math expression using RPN (Reverse Polish Notation)
	 * <h1>Syntax:</h1>
	 * <pre>
	...
	private static double evaluateRPN(String expression, java.util.Stack<String> tks) throws MathException{
		...
		try{
			...
			else if (tk.equals("^"))  x = java.lang.Math.pow(x, y);
			else throw new MathException(expression, "Invalid operation: " + tk);
		}
		return x;
	}
